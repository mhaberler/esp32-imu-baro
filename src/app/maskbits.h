...
// trace mask values
#define INFO_BLE_ADS BIT(0)
#define INFO_BLE_SENSORS BIT(1)
#define INFO_BLE_DEQUEUED BIT(2)
#define INFO_BLE_WHITELISTED BIT(2)
#define INFO_UBLOX BIT(4)
#define INFO_UBLOX_ALL BIT(5)
